...
// Additional Information: I did the all of the test variables individualized to 1/2/3/4/5 and Q when appropiate to indicate the quicksort based objects/vars/paremeters. 
// Labeled as driver, since that's a generalized term for running a set of tasks.
// 5 Test Cases. Originally had intended to do 10, but found it redundant, as 5 covers the requirements needed/called for.
// Only the 5th test has the original array printed as it's hardcoded in, and it would take quite a while to print up to 1M random values, given the other test cases.
...
public class driver{
  public static void main(String args[])
  {
    ...
    // The almost sorted array is hardcoded in, 600/750 are in order by default
